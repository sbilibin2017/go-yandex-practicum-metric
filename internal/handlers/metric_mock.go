...
// Source: /home/sergey/Github/go-yandex-practicum-metric/internal/handlers/metric.go
...
func (m *MockMetricUpdater) Update(ctx context.Context, metrics []*models.Metrics) ([]*models.Metrics, error) {
	m.ctrl.T.Helper()
